...
ActiveRecord::Schema.define(version: 2020_02_24_121436) do
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.index ["child_category_id"], name: "index_photos_on_child_category_id"
  end
  ...
  add_foreign_key "photos", "child_categories"
end
